...
var loadCountry= document.getElementById('country');
	...
	for (i = 0; i < length; i++) {
        ...
        var calling_code=country.calling_code;
		
		var node = document.createElement("OPTION");                
        var textnode = document.createTextNode(name);
		
		node.setAttribute('value', countries[i].code);
		node.appendChild(document.createTextNode(countries[i].name));
